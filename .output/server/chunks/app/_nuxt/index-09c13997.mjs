import { createVNode, computed, withDirectives, vShow, ref, toRef, Text, Transition, watch, mergeProps, Fragment, resolveDirective, cloneVNode, shallowRef, unref, nextTick, withCtx, useSSRContext, inject } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent } from 'vue/server-renderer';
import { p as propsFactory, g as genericComponent, u as useRtl, m as makeThemeProps, I as IconValue, e as provideTheme, f as useIcon, h as flattenFragments, b as convertToUnit, k as useProxiedModel, E as EventProp, l as getUid, w as wrapInArray, r as filterInputAttrs, _ as _export_sfc, a as getCurrentInstanceName, d as destructComputed, i as includes, j as useLocale, S as SUPPORTS_INTERSECTION, n as isOn, o as pick, q as useToggleScope, s as callEvent } from '../server.mjs';
import { m as makeComponentProps, a as makeTagProps, u as useRender, b as useLayout, c as useSsrBoot, d as makeTransitionProps, V as VSlideYTransition, M as MaybeTransition, e as useTextColor, f as makeRoundedProps, g as useBackgroundColor, h as useRounded, i as VExpandXTransition, j as intersect } from './index-e6af5a61.mjs';
      ...
      if (_push2) {
        _push2(ssrRenderComponent(VContainer, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(VTextField, { label: "Nome" }, null, _parent3, _scopeId2));
            } else {
              return [
                createVNode(VTextField, { label: "Nome" })
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=index-09c13997.mjs.map
