import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, defineAsyncComponent, Fragment, reactive, computed, watchEffect, toRefs, ref, unref, provide, defineComponent as defineComponent$1, createVNode, mergeProps, inject as inject$1, watch, onScopeDispose, toRaw, h, shallowReactive, Suspense, nextTick, Transition, warn, effectScope, useSSRContext, createApp, shallowRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, isReadonly, markRaw, isRef, isShallow, isReactive, withCtx } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, h as createError$1, l as defu, m as createHooks, w as withQuery, n as hasProtocol, p as parseURL, o as isScriptProtocol, j as joinURL, q as sanitizeStatusCode } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-09c13997.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-5ad3e1a5.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-c9d290a7.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./_nuxt/default-1631bf95.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex h-screen justify-center items-center flex-col" }, _attrs))}><h1 class="text-9xl">${ssrInterpolate(unref(error).statusCode)}</h1><p class="mt-7 text-4xl">${ssrInterpolate(unref(error).message)}</p><button class="rounded mt-7 text-2xl bg-blue-400 px-7 py-4 text-white">Go Back</button></div>`);
    };
  }
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-b1daf68f.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { isCssColor as A, isParsableColor as B, parseColor as C, getForeground as D, EventProp as E, IconValue as I, SUPPORTS_INTERSECTION as S, _export_sfc as _, getCurrentInstanceName as a, convertToUnit as b, createError as c, destructComputed as d, entry$1 as default, provideTheme as e, useIcon as f, genericComponent as g, flattenFragments as h, includes as i, useLocale as j, useProxiedModel as k, getUid as l, makeThemeProps as m, isOn as n, pick as o, propsFactory as p, useToggleScope as q, filterInputAttrs as r, callEvent as s, useNuxtApp as t, useRtl as u, provideDefaults as v, wrapInArray as w, getCurrentInstance as x, clamp as y, findChildrenWithProvide as z };
